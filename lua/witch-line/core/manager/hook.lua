...
--- @param comp ManagedComponent The component to get the context for
...
do
	...
	--- @param comp ManagedComponent The component to get the static data for
...
--- @param comp ManagedComponent The component to get the event info for
